...
namespace FOV.Infrastructure.Migrations
{
    ...
    [Migration("20240919102455_FixRestaurant-v1")]
    partial class FixRestaurantv1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FOV.Domain.Entities.ComboAggregator.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpiredDate = new DateTime(2024, 10, 19, 10, 24, 54, 593, DateTimeKind.Utc).AddTicks(8142),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            ComboName = "Combo 2",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ExpiredDate = new DateTime(2024, 11, 19, 10, 24, 54, 593, DateTimeKind.Utc).AddTicks(8155),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PercentReduce = 5.0m,
                            Price = 30.00m,
                        ...
                        new
                        {
                            ...
                            ComboName = "Combo 3",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ExpiredDate = new DateTime(2024, 11, 19, 10, 24, 54, 593, DateTimeKind.Utc).AddTicks(8159),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PercentReduce = 5.0m,
                            Price = 30.00m,
            ...
            modelBuilder.Entity("FOV.Domain.Entities.UserAggregator.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            EmployeeCode = "EMP001",
                            HireDate = new DateTime(2024, 9, 19, 10, 24, 54, 594, DateTimeKind.Utc).AddTicks(812),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedBy = "manager",
                            EmployeeCode = "EMP002",
                            HireDate = new DateTime(2024, 9, 19, 10, 24, 54, 594, DateTimeKind.Utc).AddTicks(938),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            EmployeeCode = "EMP003",
                            HireDate = new DateTime(2024, 9, 19, 10, 24, 54, 594, DateTimeKind.Utc).AddTicks(949),
                            IsDeleted = false,
