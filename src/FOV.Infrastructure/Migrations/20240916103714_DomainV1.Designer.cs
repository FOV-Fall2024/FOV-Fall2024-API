<<<<<<<< HEAD:src/FOV.Infrastructure/Migrations/20240916170704_FixAttendanceDomain.Designer.cs
﻿// <auto-generated />
using System;
...
{
    [DbContext(typeof(FOVContext))]
    [Migration("20240916103714_DomainV1")]
            ...
            modelBuilder.Entity("FOV.Domain.Entities.ComboAggregator.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComboName = "Combo 1",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ExpiredDate = new DateTime(2024, 10, 16, 10, 37, 13, 515, DateTimeKind.Utc).AddTicks(7742),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PercentReduce = 10.0m,
                            Price = 50.00m,
                        ...
                        new
                        {
                            ...
                            ComboName = "Combo 2",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ExpiredDate = new DateTime(2024, 11, 16, 10, 37, 13, 515, DateTimeKind.Utc).AddTicks(7755),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PercentReduce = 5.0m,
                            Price = 30.00m,
                        ...
                        new
                        {
                            ...
                            ComboName = "Combo 3",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ExpiredDate = new DateTime(2024, 11, 16, 10, 37, 13, 515, DateTimeKind.Utc).AddTicks(7759),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PercentReduce = 5.0m,
                            Price = 30.00m,
            ...
            modelBuilder.Entity("FOV.Domain.Entities.UserAggregator.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            EmployeeCode = "EMP001",
                            HireDate = new DateTime(2024, 9, 16, 10, 37, 13, 516, DateTimeKind.Utc).AddTicks(1188),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(2022, 1, 15, 10, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedBy = "admin",
                            RestaurantId = new Guid("d42cf3c6-cbe4-4431-ac91-9eae870fa007"),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "manager",
                            EmployeeCode = "EMP002",
                            HireDate = new DateTime(2024, 9, 16, 10, 37, 13, 516, DateTimeKind.Utc).AddTicks(1284),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(2022, 5, 10, 9, 30, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedBy = "manager",
                            RestaurantId = new Guid("d42cf3c6-cbe4-4431-ac91-9eae870fa007"),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            EmployeeCode = "EMP003",
                            HireDate = new DateTime(2024, 9, 16, 10, 37, 13, 516, DateTimeKind.Utc).AddTicks(1297),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(2023, 3, 20, 14, 15, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedBy = "admin",
                            RestaurantId = new Guid("d42cf3c6-cbe4-4431-ac91-9eae870fa007"),
...
>>>>>>>> 30641d1 (adjust-feat: ....):src/FOV.Infrastructure/Migrations/20240916103714_DomainV1.Designer.cs
