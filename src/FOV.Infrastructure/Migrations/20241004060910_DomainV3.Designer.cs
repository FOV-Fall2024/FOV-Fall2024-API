...
namespace FOV.Infrastructure.Migrations
{
    ...
    [Migration("20241004060910_DomainV3")]
    partial class DomainV3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FOV.Domain.Entities.ComboAggregator.Combo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpiredDate = new DateTime(2024, 11, 4, 6, 9, 9, 889, DateTimeKind.Utc).AddTicks(3891),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            ComboName = "Combo 2",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ExpiredDate = new DateTime(2024, 12, 4, 6, 9, 9, 889, DateTimeKind.Utc).AddTicks(3903),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PercentReduce = 5.0m,
                            Price = 30.00m,
                        ...
                        new
                        {
                            ...
                            ComboName = "Combo 3",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ExpiredDate = new DateTime(2024, 12, 4, 6, 9, 9, 889, DateTimeKind.Utc).AddTicks(3907),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            PercentReduce = 5.0m,
                            Price = 30.00m,
            ...
            modelBuilder.Entity("FOV.Domain.Entities.RestaurantAggregator.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ReleaseDate = new DateTimeOffset(new DateTime(2024, 10, 11, 6, 9, 9, 895, DateTimeKind.Unspecified).AddTicks(5592), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ReleaseDate = new DateTimeOffset(new DateTime(2024, 10, 11, 6, 9, 9, 895, DateTimeKind.Unspecified).AddTicks(5621), new TimeSpan(0, 0, 0, 0, 0)),
