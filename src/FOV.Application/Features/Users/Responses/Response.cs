...
public sealed record GetAllEmployeeResponse(string Id, string FullName, string PhoneNumber, string EmployeeCode, DateTime HireDate, string RoleName, Guid RestaurantId, Status Status, DateTimeOffset Created);
