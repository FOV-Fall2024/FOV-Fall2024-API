...
public record CreateIngredientGeneralCommand(string IngredientGeneralName, string IngredientGeneralDescription, Guid IngredientType, int IngredientMeasureType) : IRequest<Guid>;
public class CreateIngredientGeneralHandler(IUnitOfWorks unitOfWorks) : IRequestHandler<CreateIngredientGeneralCommand, Guid>
{
    ...
    {
        IngredientGeneral ingredientGeneral = new(request.IngredientGeneralName, request.IngredientGeneralDescription, request.IngredientType, TransferType.Transfer(request.IngredientMeasureType));
