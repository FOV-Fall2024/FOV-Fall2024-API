...
public record GetDetailIngredientGeneralResponse(Guid Id, string IngredientGeneralName, Guid IngredientGeneralType, IngredientMeasure IngredientMeasureType, string IngredientGeneralDescription, Status Status, DateTime CreatedDate);
