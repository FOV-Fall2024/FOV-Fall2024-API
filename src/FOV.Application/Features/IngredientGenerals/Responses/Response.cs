...
public record GetDetailIngredientGeneralResponse(Guid Id, string IngredientGeneralName, Guid IngredientTypeId, IngredientMeasure IngredientMeasureType, string IngredientGeneralDescription, Status Status, DateTime CreatedDate);
