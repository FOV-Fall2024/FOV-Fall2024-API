...
public record GetDetailIngredientGeneralResponse(Guid Id, string IngredientGeneralName, Guid IngredientType, IngredientMeasure IngredientMeasureType, string IngredientGeneralDescription, Status Status, DateTime CreatedDate);
