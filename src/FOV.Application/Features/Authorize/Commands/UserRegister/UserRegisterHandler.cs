...
public class UserRegisterHandler(UserManager<User> userManager, IUnitOfWorks unitOfWorks, RoleManager<ApplicationRole> roleManager) : IRequestHandler<UserRegisterCommand, Result>
{
