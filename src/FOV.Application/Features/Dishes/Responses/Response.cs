...
public sealed record GetMenuResponse(Guid Id, string DishName, int Quantity, string Price, string OriginalPrice, decimal PercentagePriceDifference, string DishDescription, DateTime CreatedDate, List<GetAdditionalImage> Images, string CategoryName, string Type, Status Status, bool IsRefundDish);
