...
public sealed record GetMenuResponse(Guid Id, string DishName, string Price, decimal PercentagePriceDifference, string DishDescription, DateTime CreatedDate, List<GetAdditionalImage> Images, string CategoryName, string Type, Status Status);
