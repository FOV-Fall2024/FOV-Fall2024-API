...
public sealed record GetMenuResponse(Guid Id, string DishName, string Price, string DishDescription, DateTime CreatedDate, List<GetAdditionalImage> Images, string CategoryName, string Type);
