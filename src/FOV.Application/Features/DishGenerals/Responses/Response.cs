...
public record GetProductGeneralResponse(Guid Id, string DishGeneralName, decimal DishGeneralPrice, string DishGeneralDescription, Status Status,bool IsRefund, string CategoryName, DateTime CreatedDate, DateTime UpdateTime, decimal PercentagePriceDifference, List<GetAdditionalImage> Images);
